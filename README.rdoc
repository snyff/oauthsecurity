...
ClientSit provides simple, vanilla piece of JS code that really "cares" about your client-side - it sends all errors to ClientSit server so you can fix it, but the most important part - you get know about that bug ASAP!

Start using right away! http://clientsit.heroku.com
